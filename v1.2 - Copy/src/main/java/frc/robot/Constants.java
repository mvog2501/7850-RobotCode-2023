...
public final class Constants {
  public static class OperatorConstants {
    ...
    public static class DriveConstants {
      ...
      public static final double kFrontLeftDriveAbsoluteEncoderOffsetDeg = -32.43; // Determine our values
      public static final double kFrontRightDriveAbsoluteEncoderOffsetDeg = -257.16; // Determine our values
      public static final double kBackLeftDriveAbsoluteEncoderOffsetDeg = -355.69; // Determine our values
      public static final double kBackRightDriveAbsoluteEncoderOffsetDeg = -193.18; // Determine our values
